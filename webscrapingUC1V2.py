def webscrapingShampoo():
  ...
  print("NUMBER PRODUCT ON WEBPAGE: ")
  print(len(products))

  print("NUMBER PRODUCTS WE WANT TO SCRAPE")
  print(min_nb_products_scrape)


  # ---- WEBSCRAPING COMMENTS SHOWED ----

  # it is to scrape the number of products we want
  count_product = 0
